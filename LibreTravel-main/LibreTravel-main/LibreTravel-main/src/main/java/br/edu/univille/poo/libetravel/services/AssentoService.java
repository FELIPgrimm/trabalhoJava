...
public class AssentoService {
    ...
    public void gerarAssentosParaAeronave(Aeronave aeronave, double precoJanela, double precoMeio, double precoCorredor) {
        List<Assento> assentos = Assento.gerarAssentos(aeronave, precoJanela, precoMeio, precoCorredor);


        repository.saveAll(assentos);
    }

    public List<Assento> listarAssentosPorAeronave(Long aeronaveId) {
        return repository.findByAeronaveId(aeronaveId);
    }
}
